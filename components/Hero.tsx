...
const Hero: React.FC<{ t: TranslationType }> = ({ t }) => {
  ...
  return (
    <section className="relative pt-25 pb-20 md:pt-28 md:pb-45 px-6 overflow-hidden min-h-[90vh] flex items-center justify-center bg-gradient-to-b from-[#0a0a0f]/90 to-transparent">
      {/* Background Glows */}
