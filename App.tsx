      ...
      <section className="relative pt-32 pb-24 px-6 overflow-hidden min-h-screen flex items-center">
        ...
        <div className="max-w-6xl mx-auto relative z-10 text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-16">
            <a href="#contact" className="group px-8 py-4 bg-gradient-to-r from-violet-600 to-purple-600 rounded-full font-bold text-lg hover:shadow-2xl hover:shadow-violet-500/50 transition-all hover:scale-105 flex items-center gap-2">
